                ...
                <div class="card-header pb-0">
                    <div class="row">
                        ...
                        {{-- <div class="col-6 text-end">
                            <a class="btn bg-gradient-info mb-0" href="banned-petugas">Petugas dilarang</a>
                            <a class="btn bg-gradient-dark mb-0" href="tambah-ulasan"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Review</a>
                        </div> --}}
                    </div>
                </div>
