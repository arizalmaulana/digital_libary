...
<div class="container-fluid py-4">
    ...
    <div class="col-12">
        ...
        <div class="card-body px-4  pt-3 pb-2">
            ...
            <form action="/edit-kategori/{{ $category->slug }}" method="post">
                @csrf
                @method('put')
                <div class="align-items-center mb-0">
                    <div class="mb-3">
                        <label for="category_name" class="form-label">Kategori</label>
                        <input type="text" name="category_name" id="category_name" class="form-control" value="{{ $category->category_name }}" placeholder="Kategori" aria-label="Kategori" aria-describedby="category_name-addon" required>
                    </div>
                </div>
